...
my_db <- src_mysql(dbname = Sys.getenv("mlb_db_dbname"), host=Sys.getenv("mlb_db_hostname"), port = 5432, user = Sys.getenv("mlb_db_username"), password = Sys.getenv("mlb_db_password")) 
